// CrowdSimulator - AgentMovementBehaviour.cs
// 
...
namespace CrowdSimulator.Behaviour
{
    public class AgentMovementBehaviour : IMovementBehaviour
    {
        ...
        public Vector2 Move(Human LeMe, IEnumerable<Human> NearestNeighbours)
        {
            ...
            velocity = Vector2.Multiply(this.velocity, 1.0f / this.velocity.LengthFast);
            velocity = Vector2.Multiply(this.velocity, this.speed);
