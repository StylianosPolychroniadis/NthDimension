namespace NthDimension.Procedural
{
    ...
    public class WordGenerator
    {
        ...
        public WordGenerator(string separator = " ", Casing casing = Casing.LowerCase, int? seed = null)
        {
        ...
        /// </example>
        public WordGenerator(string separator, Casing casing, params WordBank[] wordBanks) : this(separator, casing)
        {
            Parts = wordBanks;
        }
