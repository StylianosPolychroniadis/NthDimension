...
namespace NthDimension.Procedural.Room
{
	public class Furnisher
	{
        ...
        // Methods
        public IEnumerable<FittingType> GetFittingTypes()
        {
            return this.fittingTypes;
        }
        public IEnumerable<FittingModel> GetFittingModels()
        {
            return this.fittingModels;
        }
        public IEnumerable<FaceType> GetFittingFaceTypes()
        {
