namespace NthDimension.Procedural.Text.WordRepos
{
    public class JobTitlesRepository : WordRepository
    {
        public JobTitlesRepository() : base(
            ...
            "Ambulance Drivers",
            "Amusement Park and Recreation Attendants",
            "Anesthesiologist",
            "Animal Breeder",
            ...
            "Disk Jockey",
            "Safety Vehicle Dispatcher",
            "Door To Door Salesmen",
            "Dry Wall Installer",
            "Economics Professor",
            "Editorial Writer Newspapers and Magazines",
            ...
            "Hand Sewer",
            "Harbor Master",
            "Harbor Lake and Waterways Police",
            ...
            "Health Psychologist",
            "Hearing Officer",
            "Heating AC Refrigeration Technician",
            ...
            "Vineyard Horticulturist",
            "Hospital Administrator",
            "Hospital Nurse",
            "Hosts and Hostesses",
            "Hotel and Motel Desk Clerks",
            "Hotel Convention Event Coordinator",
            "Hotel Manager",
            ...
            "Powerline Installer and Mechanic",
            ...
            "Radio and TV Program Director",
            "Radio and TV Sports Announcer",
            "Radio and TV Station Administrator",
