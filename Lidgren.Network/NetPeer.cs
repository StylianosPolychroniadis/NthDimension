...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		public void Start()
		{
			...
			if (m_configuration.NetworkThreadName == NetworkConstants.NetworkThreadName)
			{
				int pc = Interlocked.Increment(ref s_initializedPeersCount);
				m_configuration.NetworkThreadName = string.Format("{0} {1}", NetworkConstants.NetworkThreadName,  pc.ToString());
			}
