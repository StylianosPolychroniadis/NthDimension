...
namespace NthDimension.Forms
{
    ...
    {
        public static DragDropPackage CurrentPackage;
        public static Widget HoveredControl;
        public static Widget SourceControl;

        private static Widget m_LastPressedControl;
        private static Widget m_NewHoveredControl;
        private static System.Drawing.Point m_LastPressedPos;
        ...
        private static void UpdateHoveredControl(Widget control, int x, int y)
        {
            throw new NotImplementedException();
            ////
        ...
        public static bool Start(Widget control, DragDropPackage package)
        {
            if (CurrentPackage != null)
            {
                return false;
        ...
        public static bool OnMouseButton(Widget hoveredControl, int x, int y, bool down)
        {
            if (!down)
            {
                m_LastPressedControl = null;
            ...
            m_LastPressedPos = new System.Drawing.Point(x, y);
            m_LastPressedControl = hoveredControl;

            return false;
        }

        public static void OnMouseMoved(Widget hoveredControl, int x, int y)
        {
        ...
        public static void RenderOverlay(Widget canvas/*Canvas canvas, Themes.ThemeEngine.ThemeEngine skin*/)
        {
            throw new NotImplementedException();
            ...
            ////System.Drawing.Point old = RendererBase.Singleton.RenderOffset;

            ////RendererBase.Singleton.AddRenderOffset(new Rectangle(
            ...
            ////RendererBase.Singleton.RenderOffset = old;
        }

        public static void ControlDeleted(Widget control)
        {
