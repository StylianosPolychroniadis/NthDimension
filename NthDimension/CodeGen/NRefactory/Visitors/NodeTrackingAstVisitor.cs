...
namespace NRefactory.Visitors {
	...
	public abstract class NodeTrackingAstVisitor : AbstractAstVisitor {
		...
		public sealed override object VisitAttribute(NRefactory.Ast.Attribute attribute, object data) {
		...
		public virtual object TrackedVisit(NRefactory.Ast.Attribute attribute, object data) {
