...
using NRefactory.Parser;
using NRefactory.Parser.CSharp;
...
namespace NRefactory.PrettyPrinter
{
	public sealed class CSharpOutputVisitor : IOutputAstVisitor
	{
		...
		#region NRefactory.Parser.IASTVisitor interface implementation
		...
		public object VisitAttribute(NRefactory.Ast.Attribute attribute, object data)
		{
