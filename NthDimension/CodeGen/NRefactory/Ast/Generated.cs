...
namespace NRefactory.Ast {
	...
	public class AttributeSection : AbstractNode {
		...
		List<NRefactory.Ast.Attribute> attributes;
		...
		public List<NRefactory.Ast.Attribute> Attributes {
			get {
				return attributes;
			}
			set {
		...
		public AttributeSection(string attributeTarget, List<NRefactory.Ast.Attribute> attributes) {
