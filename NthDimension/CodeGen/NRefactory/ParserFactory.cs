...
namespace NRefactory
{
	...
	public static class ParserFactory
	{
		public static Parser.ILexer CreateLexer(SupportedLanguage language, TextReader textReader)
		{
			switch (language) {
				case SupportedLanguage.CSharp:
					return new NRefactory.Parser.CSharp.Lexer(textReader);
				case SupportedLanguage.VBNet:
					return new NRefactory.Parser.VB.Lexer(textReader);
			}
		...
		public static IParser CreateParser(SupportedLanguage language, TextReader textReader)
		{
			...
			switch (language) {
				case SupportedLanguage.CSharp:
					return new NRefactory.Parser.CSharp.Parser(lexer);
				case SupportedLanguage.VBNet:
					return new NRefactory.Parser.VB.Parser(lexer);
			}
			throw new System.NotSupportedException(language + " not supported.");
		}
