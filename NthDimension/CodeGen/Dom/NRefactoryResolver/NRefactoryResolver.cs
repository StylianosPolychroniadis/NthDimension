namespace NthDimension.CodeGen.Dom.NRefactoryResolver
{
    using System;
    ...
    public class NRefactoryResolver : IResolver
    {
        ...
        NRefactory.Visitors.LookupTableVisitor lookupTableVisitor;
        ...
        public ResolveResult ResolveInternal(Expression expr, ExpressionContext context)
        {
            ...
            else if (expr is InvocationExpression)
            {
                ...
                else
                {
                    ...
                    if (c == null || c.ClassType != Dom.ClassType.Delegate)
                        return null;
