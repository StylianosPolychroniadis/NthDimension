...
#pragma warning disable CS0414
        float weather   = 1; // [0.5...1.0]
        float time      = 0;

        public SkySphere(SceneGame mScene):base(mScene)
        {
            Parent                      = mScene;
            this.Scene                  = mScene;
            ...
            addMesh("skydome\\skydome.obj");          // TODO:: Implement

            float skyScale = ApplicationBase.Instance.Player.ViewInfo.zFar / (float)Math.Sqrt(3);
        ...
        protected override void setSpecialUniforms(ref Shaders.Shader shader, ref MeshVbo curMesh)
        {
            ...
            //// TODO:: Implement new Uniforms (see fragment and vertex shaders below)
            /// TODO:: Mix the colors of all sunlights // ie foreach(Scene.SunLight)
            ///                                                 sunColor = sunlight.Color; sunColor.Normalize()?;                                                    
            Vector3 sunColor = Scene.DirectionalLights[0].Color.Xyz; ;
