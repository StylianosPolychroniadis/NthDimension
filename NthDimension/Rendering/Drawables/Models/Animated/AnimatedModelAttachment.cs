...
{
    public sealed class AnimatedModelAttachment
    {
        ...
        public AnimatedModelAttachment(AnimatedModel parent, string attachmentName, int animationMatrix, Vector3 vertex, Vector3 offset, Quaternion orientation, string meshFile, string meshMaterialFile)
        {
