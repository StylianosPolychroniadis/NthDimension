...
namespace NthDimension.Rendering.Drawables.Voxel
{
    ...
    class VoxelMeshGenerator : VoxelManager
    {
        ...
        public MeshVbo generateMesh(VoxelDataGenerator vdata)
        {
            ...
            ApplicationBase.Instance.MeshLoader.ParseFaceList(ref surfaceMesh, false, MeshVbo.MeshLod.Level0, false, false, true);
            ...
            Utilities.ConsoleUtil.log("generated Chunk:" + ApplicationBase.Instance.VAR_StopWatch.Elapsed);
        ...
        private void generateFace(Vector3 position1, Vector3 position2, Vector3 position3, Vector3 position4, int mapping, Vector3 normal, bool isBorder)
        {
            ...
            VertexIndices vert1 = new VertexIndices(Index1, textureIndex1, Index1);
            VertexIndices vert2 = new VertexIndices(Index2, textureIndex2, Index2);
            VertexIndices vert3 = new VertexIndices(Index3, textureIndex3, Index3);
            VertexIndices vert4 = new VertexIndices(Index4, textureIndex4, Index4);
