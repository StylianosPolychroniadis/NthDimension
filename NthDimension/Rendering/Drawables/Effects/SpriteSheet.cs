...
namespace NthDimension.Rendering.Drawables.Effects
{
    using System;
    using System.IO;
    ...
    // TODO:: Use Ultrasandbox ui numbers for sprites, not this

    public class SpriteSheet //: Drawable
    {
        private int textureID = 0;
        private string spriteSheetName = string.Empty;

        public SpriteSheet(ApplicationObject parent, string filename, int spriteWidth, int spriteHeight)
            //:base(parent)
        {
            //// Assign ID and get name
            //this.textureID = Renderer GL.GenTexture();
