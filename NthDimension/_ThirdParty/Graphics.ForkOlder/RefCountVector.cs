...
namespace NthDimension
{
    ...
    public class RefCountVector : System.Collections.IEnumerable
    {
        ...
        public int increment(int index, short increment = 1)
        {
            ...
            Rendering.Utilities.ConsoleUtil.log(string.Format("RefCountVector IsValid {0}   = {1}", index, isValid(index)));
            Rendering.Utilities.ConsoleUtil.log(string.Format("RefCountVector Next > 0      = {0}", ((short)(ref_counts[index] + increment) > 0)));
