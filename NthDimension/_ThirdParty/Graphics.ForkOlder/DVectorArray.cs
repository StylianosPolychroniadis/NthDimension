...
namespace NthDimension
{
    ...
    public class DVectorArray3f : DVectorArray3<float>
    {
        ...
        public Vector3 this[int i] // public Vector3f this[int i]
        {
            get { return new Vector3(vector[3 * i], vector[3 * i + 1], vector[3 * i + 2]); }
            set { Set(i, value[0], value[1], value[2]); }
        }

        public IEnumerable<Vector3> AsVector3f()
        {
            for (int i = 0; i < Count; ++i)
                yield return this[i];
        }
    ...
    public class DVectorArray3i : DVectorArray3<int>
    {
        ...
        public Vector3i this[int i]
        {
            ...
            set { Set(i, value.X, value.Y, value.Z); }
        }
    ...
    public class DVectorArray2f : DVectorArray2<float>
    {
        ...
        public Vector2 this[int i] // public Vector2f this[int i]
        {
            get { return new Vector2(vector[2 * i], vector[2 * i + 1]); }
            set { Set(i, value[0], value[1]); }
        }
        ...
        {
            for (int i = 0; i < Count; ++i)
                yield return new Vector2d(this[i].X, this[i].Y);
        }
    };
