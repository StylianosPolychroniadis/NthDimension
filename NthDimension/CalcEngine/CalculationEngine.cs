...
namespace NthDimension.CalcEngine
{
    /// <summary>
	...
	public class CalculationEngine
	{
        ...
        Dictionary<string, FunctionDefinition> GetFunctionTable()
        {
            if (_fnTbl == null)
            {
                ...
                //// --------- ESI Routines (Add-Ins) -------------
                //throw new NotImplementedException("From BluePanel.net");
                ////EsiSteamFunctions.Register(this);
                ////EsiAirFunctions.Register(this);
                ////EsiFlowFunctions.Register(this);
                ////EsiLFactorFunctions.Register(this);
                ////EsiOpcFunctions.Register(this);
