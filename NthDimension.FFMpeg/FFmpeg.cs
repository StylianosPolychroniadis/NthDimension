...
{
	internal static unsafe class FFmpeg4 {
		...
		private const string LibAVUtil = @"FFmpeg\avutil-56";
		private const string LibAVFormat = @"FFmpeg\avformat-58";
		private const string LibAVCodec = @"FFmpeg\avcodec-58";
		private const string LibSwScale = @"FFmpeg\swscale-5";
		private const string LibSwResample = @"FFmpeg\swresample-3";
