...
namespace NthStudio.Nodes
{
	...
	{
		public MultiplyNode(int p_X, int p_Y, NodeViewState p_View, bool p_CanBeSelected) : base(p_X, p_Y, p_View, p_CanBeSelected)
		{
			this.m_sName = "A*B";
		...
		public MultiplyNode(XmlTreeNode p_TreeNode, NodeViewState p_View) : base(p_TreeNode, p_View)
		{
			this.m_sName = "A*B";
			this.m_Plugs.Add(new NodeGraphPlug("A", this, ConnectorType.FluidInlet, 0, "Float", LinkVisualStyle.BezierCurve));
			this.m_Plugs.Add(new NodeGraphPlug("B", this, ConnectorType.FluidInlet, 1, "Float", LinkVisualStyle.BezierCurve));
