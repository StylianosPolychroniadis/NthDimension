...
namespace NthStudio.Utilities
{
        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            foreach (PropertyDescriptor pd in pdc)
            {
                ...
                if (attribute != null)
                {
                    ...
                    orderedProperties.Add(new PropertyOrderPair(pd.Name, order++));
                }
                else
                {
                    //
    ...
    // The hack below cannot really work for inherited classes as the number of categories may be uknown. If the number
    // of categories is Always known then it works
