...
using NthStudio.Gui.Widgets.TextEditor.Document.HighlightStrategy.SyntaxModes;
    ...
    public static class HighlightingDefinitionParser
    {
        ...
        public static DefaultHighlightingStrategy Parse(DefaultHighlightingStrategy highlighter, SyntaxMode syntaxMode, XmlReader xmlReader)
        {
            ...
            try
            {
                ...
                Stream shemaStream = typeof(HighlightingDefinitionParser).Assembly.GetManifestResourceStream(StringConstants.TextEditorDefinitionsSchema);
