...
namespace NthStudio.Gui.Widgets.TextEditor.Document
{
    ...
    public class TextWord
    {
        ...
        public sealed class SpaceTextWord : TextWord
        {
            ...
            public override NanoFont GetFont(ITextEditorProperties fontContainer)
            {
                return null;
            }
        ...
        public sealed class TabTextWord : TextWord
        {
            ...
            /*public override NanoFont GetFont(FontContainer fontContainer)
			{
				return null;
			}*/
        ...
        public virtual NanoFont GetFont(ITextEditorProperties fontContainer)
        {
        ...
        {
            return "[TextWord: Word = " + Word + ", TextColor = " + Color + "]";
        }
    }
}
