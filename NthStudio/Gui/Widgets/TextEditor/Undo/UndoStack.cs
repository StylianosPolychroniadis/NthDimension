...
namespace NthStudio.Gui.Widgets.TextEditor.Undo
{
    ...
    public class UndoStack
    {
        ...
        public TextEditorBase TextEditorControl = null;
        ...
        public void Push(IUndoableOperation operation)
        {
            ...
            if (AcceptChanges)
            {
                ...
                {
                    undostack.Push(new UndoableSetCaretPosition(this, TextEditorControl.ActiveTextArea.Caret.Position));
                    actionCountInUndoGroup++;
                }
                EndUndoGroup();
                ClearRedoStack();
        ...
        class UndoableSetCaretPosition : IUndoableOperation
        {
            ...
            public void Undo()
            {
                redoPos = stack.TextEditorControl.ActiveTextArea.Caret.Position;
                stack.TextEditorControl.ActiveTextArea.Caret.Position = pos;
                stack.TextEditorControl.ActiveTextArea.SelectionManager.ClearSelection();
            }

            public void Redo()
            {
                stack.TextEditorControl.ActiveTextArea.Caret.Position = redoPos;
                stack.TextEditorControl.ActiveTextArea.SelectionManager.ClearSelection();
            }
        }
    }
