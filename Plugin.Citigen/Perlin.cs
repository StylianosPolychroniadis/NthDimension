...
namespace RoadGen
{
  ...
  138, 236, 205, 93, 222, 114, 67, 29, 24, 72, 243, 141, 128, 195, 78, 66, 215, 61, 156, 180 };
        ...
        private static readonly float F2 = 0.5f * ((float)System.Math.Sqrt(3) - 1);
        private static readonly float G2 = (3 - (float)System.Math.Sqrt(3)) / 6.0f;
        ...
        {
            /* Refactoring: Also see the lines above, switched to System.Math fro MathHelper     
             *  // Skewing and unskewing factors for 2, 3, and 4 dimensions
                   private static readonly float F2 = 0.5f * ((float)System.Math.Sqrt(3) - 1);
                   private static readonly float G2 = (3 - (float)System.Math.Sqrt(3)) / 6.0f; 
             * 
            ...
            throw new System.NotImplementedException();
            {
                ...
                ////var i = MathHelper.FloorToInt(xin + s);
                ////var j = MathHelper.FloorToInt(yin + s);
