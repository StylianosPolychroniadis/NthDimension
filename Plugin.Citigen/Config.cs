    ...
    public class Config
    {
        ...
        private static float RandomAngle(float limit)
        {
            throw new System.NotImplementedException();
            {
                ...
                //nonUniformNorm = MathHelper.Pow(Math.Abs(limit), 3);
                //value = 0;
        ...
        //private static NthDimension.Algebra.Rect quadtreeParams = new NthDimension.Algebra.Rect(-20000, -20000, 40000, 40000);

        //public static NthDimension.Algebra.Rect QuadtreeParams
        //{
        //    get
        //    {
