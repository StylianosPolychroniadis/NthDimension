        ...
        public static void Spawn(Segment segment, int density, float radius, Quadtree quadtree, ref List<Allotment> newAllotments)
        {
            ...
            for (int i = 0; i < density; i++)
            {
                throw new System.NotImplementedException();
                {
                    ...
                    //float randomAngle = UnityEngine.Random.value * 2.0f * MathHelper.PI;
                    //float randomRadius = UnityEngine.Random.value * radius;
                    //Vector2 center = new Vector2(
                    //    segmentCenter.X + randomRadius * MathHelper.Sin(randomAngle),
                    //    segmentCenter.Y + randomRadius * MathHelper.Cos(randomAngle)
                    //);
