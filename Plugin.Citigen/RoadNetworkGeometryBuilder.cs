...
namespace RoadGen
{
    public class RoadNetworkGeometryBuilder
    {
        ...
        {
            float l = a.Length * b.Length; // magnitude Length
            if (l == 0)
                return 0;
            ...
            throw new System.NotImplementedException();
            {
                ...
                //float angle = MathHelper.Acos(Vector2.Dot(a, b) / l);
                //if ((a.X * b.Y - a.Y * b.X) >= 0)
                //    return angle;
                //else
                //    return 2 * MathHelper.PI - angle;
            }
        }
        ...
        {
            Vector2 dir = (c1 - c0);
            float length = dir.Length;// magnitude;
            dir /= length;
            int N;
            ...
            throw new System.NotImplementedException();
            {
                ...
                //if (lengthStep > 0)
                //    N = MathHelper.CeilToInt(length / lengthStep);
                //else
                //    N = 1;
        ...
        )
        {
            ...
            else
            {
                ...
                positions1.Add(p2);
                positions1.Add(p3);
                o_v = v + (start - origin).Length;// magnitude;
        ...
        )
        {
            ...
            else
            {
                ...
                positions1.Add(p2);
                positions1.Add(p3);
                n_v = v + (start - origin).Length; // magnitude;
                uvs.Add(new Vector2(0, n_v));
                uvs.Add(new Vector2(u, n_v));
            }
            p0 = p2;
