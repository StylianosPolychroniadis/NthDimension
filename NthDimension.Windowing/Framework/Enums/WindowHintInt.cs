namespace NthDimension.Windowing.Framework
{
    ...
    /// </summary>
    /// <seealso cref="Framework.WindowHint(WindowHintInt,int)"/>
    public enum WindowHintInt
    {
        ...
        /// <see cref="Framework.DontCare"/> means the application has no preference.
        /// </summary>
        RedBits = 0x00021001,
        ...
        /// If set to <see cref="Framework.DontCare"/>,
