...
using NthDimension.Windowing.Input;
...
namespace NthDimension.Windowing.Desktop
{
    ...
    public class NativeWindow : IDisposable
    {
        ...
        /// </summary>
        [Obsolete("Use " + nameof(NthDimension.Windowing.Framework.MouseState.Delta) + " member of the " + nameof(NativeWindow.MouseState) + " property instead.", true)]
        ...
        ///     This value is updated with the new state every time the window processes events.
        /// </summary>
        [Obsolete("Use " + nameof(NthDimension.Windowing.Framework.MouseState.WasButtonDown) + " and " + nameof(NthDimension.Windowing.Framework.MouseState.PreviousPosition) + " members of the " + nameof(NativeWindow.MouseState) + " property instead.", true)]
        ...
        public WindowIcon Icon
        {
            ...
            set
            {
                unsafe
                {
                    ...
                    Span<Framework.Image> glfwImages =
                        stackalloc Framework.Image[images.Length];
                    ...
                    for (var i = 0; i < images.Length; i++)
                    {
                        ...
                        glfwImages[i] =
                            new Framework.Image(image.Width, image.Height, addrOfPinnedObject);
                    }
        ...
        public unsafe MonitorHandle CurrentMonitor
        {
            ...
            set
            {
                var monitor = value.ToUnsafePtr<Framework.Monitor>();
            ...
            set
            {
                ...
                unsafe
                {
                    ...
                    if (value.Shape == MouseCursor.StandardShape.CustomShape)
                    {
                        ...
                        {
                            var cursorImg = new Framework.Image(value.Width, value.Height, ptr);
        ...
        public unsafe NativeWindow(NativeWindowSettings settings)
        {
            ...
            {
                var monitor = settings.CurrentMonitor.ToUnsafePtr<Framework.Monitor>();
        ...
        private unsafe void UpdateWindowForStateAndVisibility()
        {
            ...
            switch (_windowState)
            {
                ...
                case WindowState.Fullscreen:
                    ...
                    var monitor = CurrentMonitor.ToUnsafePtr<Framework.Monitor>();
                    var modePtr = GLFW.GetVideoMode(monitor);
        ...
        private unsafe void MouseButtonCallback(Window* window, NthDimension.Windowing.Framework.MouseButton button, InputAction action, KeyModifiers mods)
        {
        ...
        private unsafe void DropCallback(Window* window, int count, byte** paths)
        {
            ...
            {
                arrayOfPaths[i] = Utility.MarshalUtility.PtrToStringUTF8(paths[i]);
            }
        ...
        public bool IsMouseButtonDown(NthDimension.Windowing.Framework.MouseButton button)
        {
        ...
        public bool IsMouseButtonPressed(NthDimension.Windowing.Framework.MouseButton button)
        {
        ...
        public bool IsMouseButtonReleased(NthDimension.Windowing.Framework.MouseButton button)
        {
            return !MouseState.IsButtonDown(button) && MouseState.WasButtonDown(button);
        }
