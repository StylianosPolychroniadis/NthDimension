...
namespace NthDimension.Physics.Dynamics
{
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        /// the next time <see cref="PhysicsWorld.Step"/> is called. The 'impact'
        /// of the force depends on the time it is applied to a body - so
        /// the timestep influences the energy added to the body.
        /// </summary>
        /// <param name="force">The force to add next <see cref="PhysicsWorld.Step"/>.</param>
        ...
        /// the timestep influences the energy added to the body.
        /// </summary>
        /// <param name="torque">The torque to add next <see cref="PhysicsWorld.Step"/>.</param>
