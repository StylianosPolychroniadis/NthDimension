...
namespace NthDimension.Physics.Collision.Shapes
{
    ...
    public class ConeShape : Shape
    {
        ...
        {
            sina = radius / (float)System.Math.Sqrt(radius * radius + height * height);
            base.UpdateShape();
        }
        ...
        public override void SupportMapping(ref JVector direction, out JVector result)
        {
            ...
            float sigma = (float)System.Math.Sqrt((float)(direction.X * direction.X + direction.Z * direction.Z));
