...
using NthDimension.Physics.DataStructures;
...
namespace NthDimension.Physics
{
    ...
    public class PhysicsWorld
    {
        ...
        /// active arbiter in the <see cref="PhysicsWorld"/> are stored in this map.
        /// </summary>
        ...
        /// <summary>
        /// Create a new instance of the <see cref="PhysicsWorld"/> class.
        /// </summary>
        ...
        /// </param>
        public PhysicsWorld(CollisionSystem collision)
        {
            if (collision == null)
        ...
        /// <summary>
        /// Gets or sets the gravity in this <see cref="PhysicsWorld"/>. The default gravity
        /// is (0,-9.81,0)
        /// </summary>
        ...
        public void Step(float timestep, bool multithread)
        {
            ...
            // Calculate this
            currentAngularDampFactor = (float)System.Math.Pow(angularDamping, timestep);
            currentLinearDampFactor = (float)System.Math.Pow(linearDamping, timestep);
        ...
        private void IntegrateCallback(object obj)
        {
            ...
            if (!(body.isParticle))
            {
                ...
                else
                {
                    ...
                    JVector.Multiply(ref body.angularVelocity, ((float)System.Math.Sin(0.5f * angle * timestep) / angle), out axis);
                }

                JQuaternion dorn = new JQuaternion(axis.X, axis.Y, axis.Z, (float)System.Math.Cos(angle * timestep * 0.5f));
