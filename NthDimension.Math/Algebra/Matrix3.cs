...
namespace NthDimension.Algebra
{
    ...
    public struct Matrix3 : IEquatable<Matrix3>
    {
        ...
        {
            Matrix3 m = this;
            m.Row0 = new Vector3(m.Row0.LengthFast, 0, 0);
            m.Row1 = new Vector3(0, m.Row1.LengthFast, 0);
            m.Row2 = new Vector3(0, 0, m.Row2.LengthFast);
            return m;
        }
        ...
        /// </summary>
        public Vector3 ExtractScale() { return new Vector3(Row0.LengthFast, Row1.LengthFast, Row2.LengthFast); }
