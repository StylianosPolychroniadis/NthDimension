...
namespace NthDimension.Algebra
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public float LengthFast
        {
            get
            {
                return 1.0f / MathFunc.InverseSqrtFast(X * X + Y * Y);
            }
        }
        ...
        {
            float scale = MathFunc.InverseSqrtFast(X * X + Y * Y);
            X *= scale;
            Y *= scale;
        }
        ...
        /// <summary>
        /// This function determines the z-component by determining the cross-product based on the following formula: ((x1,y1,0) cross (x2,y2,0))
        ...
        {
            float scale = MathFunc.InverseSqrtFast(vec.X * vec.X + vec.Y * vec.Y);
            vec.X *= scale;
            vec.Y *= scale;
            return vec;
        }
