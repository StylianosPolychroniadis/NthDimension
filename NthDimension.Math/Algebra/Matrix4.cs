...
{
    /// <summary>
    /// Represents a 4x4 matrix containing 3D rotation, scale, translation, and projection.
    /// </summary>
    /// <seealso cref="Matrix4d"/>
    [Serializable, ProtoContract]//[ProtoInclude(1, typeof(Vector4))]
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        {
            Row0 = new Vector4(mat[0], mat[1], mat[2], mat[3]);
            Row1 = new Vector4(mat[4], mat[5], mat[6], mat[7]);
            Row2 = new Vector4(mat[8], mat[9], mat[10], mat[11]);
            Row3 = new Vector4(mat[12], mat[13], mat[14], mat[15]);
        }
        ...
        /// Implemented: SVD Singular Value - need to work arround resulting skew
        ///              LU (not tested)
        ///              
        ///              
        /// </summary>
        ...
        {
            //As implemented in nthDimension2013.Tesla.Math
            throw new System.NotImplementedException("See source for ref.");
        ...
        {
            Matrix4 m = this;
            m.Row0.Xyz = new Vector3(m.Row0.Xyz.LengthFast, 0, 0);
            m.Row1.Xyz = new Vector3(0, m.Row1.Xyz.LengthFast, 0);
            m.Row2.Xyz = new Vector3(0, 0, m.Row2.Xyz.LengthFast);
            return m;
        }
        /// <summary>
        ...
        /// </summary>
        public Vector3 ExtractScale() { return new Vector3(Row0.Xyz.LengthFast, Row1.Xyz.LengthFast, Row2.Xyz.LengthFast); }
