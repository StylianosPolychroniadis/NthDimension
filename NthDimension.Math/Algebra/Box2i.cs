...
namespace NthDimension.Algebra
{
    ...
    public struct Box2i : IEquatable<Box2i>
    {
        ...
        public Box2i(Vector2i min, Vector2i max)
        {
            ...
            _min = new Vector2i(System.Math.Min(min.X, max.X), System.Math.Min(min.Y, max.Y));
            _max = new Vector2i(System.Math.Max(min.X, max.X), System.Math.Max(min.Y, max.Y));
        }
        ...
        public static Box2i Intersect(Box2i a, Box2i b)
        {
            ...
            Vector2i min = new Vector2i(System.Math.Min(a.Min.X, b.Min.X), System.Math.Min(a.Min.Y, b.Min.Y));
            Vector2i max = new Vector2i(System.Math.Max(a.Max.X, b.Max.X), System.Math.Max(a.Max.Y, b.Max.Y));
        ...
        public void Inflate(Vector2i point)
        {
            ...
            _min = new Vector2i(System.Math.Min(_min.X, point.X), System.Math.Min(_min.Y, point.Y));
            _max = new Vector2i(System.Math.Max(_min.X, point.X), System.Math.Max(_min.Y, point.Y));
        }
